    ...
    text-white ${selectedUser ? 'max-md:hidden' : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          <img src={assets.logo} alt="logo" loading='lazy' className='max-w-40' />
          <div className='relative py-2 group'>
            <img src={assets.menu_icon} alt="menu" loading='lazy' className='max-h-5 cursor-pointer' />
        ...
        <div onClick={() => setSelectedUser(user)}
         ...
         cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50 '}`}>
          ...
          <div className='flex flex-col leading-5 '>
            ...
            {
              index < 3
                ? <span className='text-green-400 text-us'>Online</span>
                : <span className='text-neutral-400 text-us'>Offline</span>
            }
          </div>
